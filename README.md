...
Generative sequencing modules for [VCV Rack 2](https://vcvrack.com), by Benny
Delaney-Brownlow.
...
The Expander is optional. It mounts to Whisk's right and turns it into an
eight-scene launcher: save complete two-layer moments, recall them by button or
CV, choose whether a scene cuts in or dissolves, and shift either layer by whole
